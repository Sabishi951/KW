...
function move () {
	...
	moveTimeout = setTimeout(move, 500) // trigger move after 7 seconds without move action
	...
	if($ssj_bar.style.display === 'none' && GAME.quick_opts.ssj || GAME.ssj_end * 1000 < new Date().getTime() && GAME.quick_opts.ssj) {
